---
title: "Visualizing Data: Exercises (Part II)"
author: ""
...
1. Which errors in R are most common for you? How can you address them? (Answer below after the >.)

> 

2. Take the `friends` dataset. You can call it that rather than `newfriends`, although it is the same as the one we used during the tutorial. Do the following:
