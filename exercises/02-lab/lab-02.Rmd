...
It should just work---this is the great thing about having your working directory set! (If it doesn't work on its own, try adding `lab02/` before the name `"penguins.csv"`, and again in the code chunk below.) You might see some language about how it's been "Parsed with column specification"---great! It's telling you the types (classes) of variables.
