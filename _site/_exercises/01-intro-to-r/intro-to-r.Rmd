...
[There's more info on this on the github wiki](https://github.com/jdbest/r-psych-stats/wiki/setting-a-working-directory). You can always return there with questions. 
...
If you run into any errors, consider looking to the [wiki page on troubleshooting](https://github.com/jdbest/psy-203/wiki/Installation-Errors-and-Problems) for solutions. (You can also scroll up and click "Wiki".)