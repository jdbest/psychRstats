...
If you run into any errors, consider looking to the [wiki page on troubleshooting](https://github.com/jdbest/r-psych-stats/wiki/Installation-Errors-and-Problems) for solutions. (You can also scroll up and click "Wiki".)