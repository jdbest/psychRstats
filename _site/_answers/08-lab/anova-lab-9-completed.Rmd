...
For the questions below, create your own code chunks ([how?: instructions here](https://github.com/jdbest/psy-203/wiki/Create-a-code-chunk)) and insert all code into them.
...
Have any feedback about the exercises? Let me know at the [exit survey](https://bit.ly/psy203exit) and select Lab 9.